...
# MF EDITS:
##############################
# 1 - Disable Encryption/Decryption by changing the ENCRYPTION_PIPE and
# DECRYPTION_PIPE to "cat"
# 2 - Added the Client ID and Secret to Masquerade as Thunderbird
# 3 - Changed the redirect_uri in the Google section of the registrations
# to get the authcode method to work (it doesn't out of the box)
# Original: 'redirect_uri': 'urn:ietf:wg:oauth:2.0:oob',
##############################
